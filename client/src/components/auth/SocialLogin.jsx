...
export const useGoogleAuth = (onSuccess, onError) => ({
  name: 'Google',
  icon: defaultSocialProviders[0].icon,
  color: defaultSocialProviders[0].color,
  onClick: async () => {
    try {
...
export const useGitHubAuth = (onSuccess, onError) => ({
  name: 'GitHub',
  icon: defaultSocialProviders[1].icon,
  color: defaultSocialProviders[1].color,
  onClick: async () => {
    try {
